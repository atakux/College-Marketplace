    ...
    if user_data is None:
        ...
        if request.method == 'POST':
            ...
            with sqlal_session_gen.begin() as generated_session:
                ...
                user_results = generated_session.execute('SELECT * FROM user_database WHERE user_email="{}";', [email])
                ...
                user_results = generated_session.execute('SELECT * FROM user_database WHERE user_name="{}";', [user_name])
                for ur in user_results:
                    dup_user_name = True
